<?php 
    ...
    //call the function that has been created in the function file
	$row = $fn->getPostByID( $_GET[ "id" ] );
         ...
         <div class="blog-post">
                ...
                <div class="row" style="padding:1rem; margin-bottom: 1rem;">
                      ...
                      <div class="card-signin" style="width: 70rem;  background-color: white;">
                                ...
                                <h1 class="card-title"><?php echo $row[ "post_title" ]; ?></a></h1>

                                <p class="card-time">Posted on: <?php echo date( "jS M Y H:i:s", strtotime( $row[ "post_date" ] ) ); ?></p>

                               <p class="card-content"> <?php echo $row[ "post_content"]; ?></p>
