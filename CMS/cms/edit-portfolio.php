<?php 
    ...
    //call function to get each portfolio by ID
    $media = $fn->getMediaByID( $_GET["id"] );

    //call function to edit a portfolio
	$fn->editMedia();
...
<html lang="en">
    ...
    <!-- Navigation Bar-->  
		...
		<div id="wrapper" style="color: white">
			...
			<h2 class="text-center" style="color: white; letter-spacing: 5px;">Edit Portfolio</h2>
 ...
 <!--Show error if a form is not filled-->
			...
			<form action="" method="post">
				...
				<input type='hidden' name='mediaID' value='<?php echo $media[ "media_id" ]; ?>'</p>

				<p><label><b>Title</b></label><br />
				<input type='text' name='mediaTitle' style="width: 400px; border-radius: 5px;" value=<?php echo $media[ "media_title" ]; ?>></p>

				<p><label><b>Description</b></label><br />
				<textarea name='mediaDescription' cols='60' rows='10'><?php echo $media[ "media_description" ]; ?></textarea></p>

				<p><label><b>Content</b></label><br />
				<textarea name='mediaContent' cols='60' rows='10'><?php echo $media[ "media_content" ]; ?></textarea></p>
                
				<p><input type='submit' class="btn btn-success" name='edit' value='Edit Portfolio'></p>
